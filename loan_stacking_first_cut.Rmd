...
loandata['def_in_6_months'] <- ifelse(loandata$default_4months==1 & loandata$time_to_delinq<=190,1,0)
loandata['def_after_6_months'] <- ifelse(loandata$default_4months==1 & loandata$time_to_delinq>190,1,0)
